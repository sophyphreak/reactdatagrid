...
const App = () => {
    ...
    const renderContactsGrid = ({ data }) => {
        ...
        return (React.createElement(ReactDataGrid, { defaultFilterValue: defaultFilterValue, dataSource: contactsDataSource, pagination: true, rtl: rtl, columns: contactsColumns, columnDefaultWidth: 200 }));
    };
    return (React.createElement("div", null,
        ...
        React.createElement(ReactDataGrid, { key: rtl + '', rtl: rtl, nativeScroll: nativeScroll, dataSource: accountsDataSource, style: accountsGridStyle, rowHeight: accountRowHeight, pagination: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, rowExpandHeight: accountExpandHeight, rowHeights: accountRowHeights, renderDetailsGrid: renderContactsGrid, defaultGroupBy: defaultGroupBy, columnDefaultWidth: 200, columns: columns })));
};

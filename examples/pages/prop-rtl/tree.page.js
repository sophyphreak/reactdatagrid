...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "TreeGrid with RTL"),
        React.createElement("p", null, "The \"Downloads\" node is not collapsible"),
        ...
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { checked: small, onChange: setSmall }, "Set small")),
        React.createElement(ReactDataGrid, { treeColumn: "name", key: `grid-${nativeScroll}-${small}`, rtl: rtl, nativeScroll: nativeScroll, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, defaultExpandedNodes: defaultExpandedNodes, loadNode: loadNode, onNodeCollapse: onNodeCollapse, style: { minHeight: small ? 300 : 650 }, columns: columns, dataSource: treeData })));
};

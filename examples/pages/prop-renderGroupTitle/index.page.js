...
export default function App() {
    ...
    const renderGroupTitle = React.useCallback((value, { onGroupToggle, groupProps, data }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("button", { onClick: () => gridRef?.current?.collapseAllGroups() }, "Collapse all"),
        React.createElement(ReactDataGrid, { onReady: setGridRef, idProperty: "id", columns: columns, dataSource: dataSource, defaultGroupBy: ['email'], style: { width: '100%', height: 600 }, renderGroupTitle: renderGroupTitle, expandedGroups: true })));
}

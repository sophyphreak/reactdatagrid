...
class MenuSeparator extends Component {
    render() {
        ...
        return (React.createElement("tr", { className: props.className },
            React.createElement("td", { colSpan: 100 },
                React.createElement("div", { className: `${props.rootClassName}__menu-separator__tool`, style: props.style }))));
    }
    ...
    prepareClassName(props) {
        const className = join(`${props.rootClassName}__menu-separator`, props.className);
        return className;
    }
    prepareStyle(props) {

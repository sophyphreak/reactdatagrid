...
class App extends React.Component {
            ...
            columns: [
                ...
                { name: 'age', type: 'number', defaultFlex: 1 },
                {
                    ...
                    render: ({ data, rowIndex }) => {
                        ...
                        return (React.createElement("div", { style: { height: height } }, data.firstName +
                            ', aged: ' +
                            data.age +
                            '. Lives in ' +
                            data.country));
    ...
    render() {
        ...
        return (React.createElement(DataGrid, { idProperty: "id", style: gridStyle, theme: "default-light", columns: this.state.columns, rowHeight: null, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, minRowHeight: 50, columnMinWidth: 400, dataSource: this.state.dataSource }));
    }
}

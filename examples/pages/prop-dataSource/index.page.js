...
class App extends React.Component {
    ...
    render = () => {
        return (React.createElement(React.Fragment, null,
            React.createElement(DataGrid, { idProperty: "id", theme: "default-light", checkboxColumn: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, showZebraRows: false, style: gridStyle, columnDefaultWidth: 400, defaultSortInfo: [], allowUnsort: false, columns: this.state.columns, dataSource: this.state.dataSource, onContextMenu: (...args) => {

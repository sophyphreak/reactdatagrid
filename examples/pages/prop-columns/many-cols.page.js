...
export default function App() {
    return (React.createElement(Table, { dataSource: dataSource, columns: columns(), style: { width: '100%', minHeight: '500px' }, 
        // checkboxColumn
        // showColumnMenuTool={false}
        headerHeight: 50, nativeScroll: true, virtualizeColumns: true, rowIndexColumn: true, defaultGroupBy: [] }));
}

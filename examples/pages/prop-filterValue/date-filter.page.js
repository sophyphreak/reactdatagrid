...
class App extends React.Component {
    ...
    render() {
        return (React.createElement("form", { onSubmit: () => {
            ...
            React.createElement(DateInput, { dateFormat: "YYYY-MM-DD", value: this.state.v, onChange: v => {
                    console.warn('yodate', v);
                    this.setState({ v });
                } }),
            React.createElement(DataGrid, { idProperty: "id", style: gridStyle, rowIndexColumn: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, maxRowHeight: 60, theme: "default-light", defaultCellSelection: [], defaultFilterValue: defaultFilterValue, columns: this.state.columns, dataSource: dataSource })));
    }
}

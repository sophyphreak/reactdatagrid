...
export default class InovuaDataGridColumnLayout extends React.Component {
    ...
    onResizeDownAction = (computedProps, config, { colHeaderNode, event, groupColumns }) => {
    ...
    setupColumnResize = (computedProps, { visibleIndex, groupColumns, colHeaderNode, event }) => {
    ...
    onResizeDrop = (computedProps, { index, offset, diff, groupColumns, constrained, size, nextColumnSize, firstFlexIndex, shareSpace, }) => {

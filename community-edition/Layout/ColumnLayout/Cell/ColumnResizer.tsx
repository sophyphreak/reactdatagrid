...
export default class ColumnResizer extends Component<
  TypeColumnResizerProps,
  TypeColumnResizerState
> {
  domRef: RefObject<any>;
  overHeight: number | null = 0;

  static propTypes = propTypes;

  constructor(props: TypeColumnResizerProps) {
    super(props);

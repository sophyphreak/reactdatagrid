...
class TextInput extends Component {
    ...
    render() {
        const { rootClassName, onClick, maxWidth, visible, searchable, } = this.props;
        const className = join(`${rootClassName}__wrapper`, this.props.className, !visible && `${rootClassName}__wrapper--invisible`, !searchable && `${rootClassName}__wrapper--non-searchable`);
        ...
        return (React.createElement("span", { ...cleanProps(this.props, TextInput.propTypes), onClick: onClick, className: className },
            React.createElement("input", { style: inputStyle, className: rootClassName, ref: ref => (this.inputNode = ref), type: "text", value: value || '', onChange: this.handleChange, onClick: this.onClick, tabIndex: this.props.tabIndex, onMouseDown: this.handleMouseDown, size: size }),
    ...
    renderPlaceholder() {
        ...
        return (React.createElement("span", { ...placeholderProps, ref: ref => (this.placeholderNode = ref) }, this.props.placeholder));
    }
    getValue() {
    ...
    hasFocus() {
        const activeElement = globalObject &&
    ...
    isCursorAtEndPosition() {
        const cursorLastPissiblePosition = this.props.value && this.props.value.length;

...
const App = () => {
    return (React.createElement("div", null,
        React.createElement("p", null, "In this example, you can sort the person column by the last name."),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, dataSource: dataSource, columns: columns, sortable: true, defaultSortInfo: defaultSortInfo })));
};

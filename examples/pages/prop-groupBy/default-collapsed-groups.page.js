...
export default function App() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ReactDataGrid, { onReady: setGridRef, idProperty: "id", columns: columns, dataSource: dataSource, defaultGroupBy: ['email'], style: { width: '100%', height: 600 }, defaultCollapsedGroups: true })));
}

...
class App extends Component {
    ...
    render() {
        return (React.createElement("div", null,
            ...
            React.createElement("h1", null, "Dropdown button"),
            this.state.showDD && (React.createElement(DropDownButton, { renderMenuWhenCollapsed: true, theme: this.state.theme, items: items, style: { position: 'absolute', right: 10 }, icon: React.createElement("div", null, "x") }, "Hello")),

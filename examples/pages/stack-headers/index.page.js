...
export default () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "Stacked columns example"),
        React.createElement("div", { style: { marginBottom: '20px' } },
            React.createElement(CheckBox, { checked: stackedHeaders, onChange: setStackedHeaders }, "Stacked headers")),
        React.createElement(ReactDataGrid, { idProperty: "id", style: gridStyle, columnMinWidth: 100, columns: columns, groups: stackedHeaders ? groups : undefined, dataSource: dataSource, pagination: true, defaultGroupBy: [] })));
};

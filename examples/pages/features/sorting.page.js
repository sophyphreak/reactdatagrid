...
const App = () => {
    return (React.createElement("div", null,
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, defaultSortInfo: defaultSortInfo, style: gridStyle, renderSortTool: renderSortTool, columns: columns, dataSource: people })));
};

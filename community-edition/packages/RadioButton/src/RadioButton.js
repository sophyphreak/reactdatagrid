...
const defaultCheckedIcon = ({ style, size = 16 }) => {
    return (React.createElement("svg", { style: style, width: size, height: size, viewBox: "0 0 16 16" },
        React.createElement("circle", { cx: "8", cy: "8", r: "7", fill: "none", fillRule: "evenodd", strokeWidth: "2" }),
        React.createElement("circle", { cx: "8", cy: "8", r: "3", fillRule: "evenodd", stroke: "none" })));
};
...
class InovuaRadioButton extends Component {
    ...
    render = () => {
        ...
        const className = join(`${props.rootClassName}`, props.theme && `${props.rootClassName}--theme-${props.theme}`);
        const checkboxProps = {
            ...props,
            className,
            checkedIcon,

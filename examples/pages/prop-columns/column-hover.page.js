...
const columns1 = [
    ...
    { name: 'email', groupBy: false, defaultWidth: 135, header: 'Email' },
    {
        ...
        header: 'Column 4',
        minWidth: 135,
        render: ({ data, rowIndex, columnIndex }) => 'Row ' + rowIndex + ', col ' + (columnIndex + 1),
    },
    {
        id: 'col_5',
        header: 'Column 5',
...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "Grid with column hover"),
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { checked: enableColumnHover, onChange: setEnableColumnHover }, "Enable column hover")),
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { checked: virtualizeColumns, onChange: setVirtualizeColumns }, "Virtualize columns")),
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(ComboBox, { dataSource: comboDataSource, value: theme, onChange: setTheme, changeValueOnNavigation: true, collapseOnSelect: true })),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: theme, style: gridStyle, columns: columns, dataSource: people, enableColumnHover: enableColumnHover, virtualizeColumn: virtualizeColumns, columnHoverClassName: "custom-column-hover-class-name" })));
};

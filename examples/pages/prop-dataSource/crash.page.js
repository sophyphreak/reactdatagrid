...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement(Button, { onClick: reRender }, "Crash!"),
        React.createElement(ReactDataGrid, { idProperty: "id", style: gridStyle, columns: tableColumns, pagination: true, livePagination: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, onReady: () => { }, limit: 10, dataSource: dataSource })));
};

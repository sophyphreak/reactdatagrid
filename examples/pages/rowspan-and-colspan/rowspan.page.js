...
const columns = [
    ...
    },
    {
        ...
        rowspan: ({ value, dataSourceArray, rowIndex, column }) => {
            ...
            while (dataSourceArray[currentRowIndex] &&
...
const App = () => {
    return (React.createElement("div", null,
        React.createElement("h3", null, "Rowspan and colspan example"),
        React.createElement("p", null,
            "Try and sort the ",
            React.createElement("b", null, "COUNTRY"),
            " column to see the cells with same country spanning together."),
        React.createElement(ReactDataGrid, { theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, showZebraRows: false, style: gridStyle, columns: columns, dataSource: people })));
};

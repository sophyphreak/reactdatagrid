...
export default class InovuaDataGridHeaderLayout extends Component {
  ...
  onContainerScrollHorizontal(scrollLeft: number, scrollLeftMax?: number) {
  ...
  getDragBoxInstance(dragIndex, dragTarget, dragTargetDepth, dragTargetLength) {
    if (dragTarget === 'group') {
      return (
        this.getGroupToolbar() && this.getGroupToolbar().getCells()[dragIndex]
      );
    }
  ...
  setupDrag(
    ...
    const groupToolbarCells =
      this.getGroupToolbar() && this.getGroupToolbar().getCells();

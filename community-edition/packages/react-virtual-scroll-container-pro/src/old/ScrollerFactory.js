    ...
    class VirtualScrollContainer extends React.Component {
        ...
        render() {
            ...
            content = (React.createElement(React.Fragment, null,
                this.getBefore(),
                React.createElement("div", { key: "content", ...domProps }, cloneElement(content, newContentProps)),
                this.getAfter()));
            ...
            const scrollerStyle = inertialScroll
                ...
                : SCROLLER_STYLE;
            return (React.createElement("div", { tabIndex: -1, ...cleanProps(this.props, this.constructor.propTypes), onFocus: this.onFocus, style: style, className: className, ref: this.refThis },

...
const App = () => {
    return (React.createElement("div", null,
        ...
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, rowHeight: 40, rowReorderColumn: true, columns: columns, dataSource: [].concat(people), isRowReorderValid: isRowReorderValidHandle })));
};

    ...
    render = () => {
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { style: {
                ...
                React.createElement("h2", { style: { color: '#525252' } }, "DataGrid --- Row reorder example"),
                React.createElement("div", { style: {
                        flex: 1,
                        position: 'relative',
                        height: 'calc(100% - 68px)',
                    } },
                    React.createElement(DataGrid, { idProperty: "id", theme: "default-light", rowIndexColumn: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, onRowReorder: true, style: gridStyle, columns: this.state.columns, dataSource: this.state.dataSource, rowHeight: this.state.rowHeight }))),

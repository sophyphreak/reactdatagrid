...
const App = () => {
    ...
    const { setColumnsArray, setData, setColumns, setRecords, setColumnsCount, setReinit, setLoading, setReload, } = useAppActions();
    const { records, columnsCount, columnsArray, data, loading, reload } = useAppState();
    useEffect(() => {
    ...
    return (React.createElement("div", { className: "app" },
        React.createElement("div", { className: "app-content" },
            React.createElement(Grid, { setGridRef: setGridRef, setStatus: setStatus, text: text, setText: setText }),
            React.createElement(Configurator, { gridRef: gridRef, onRecordsChange: onRecordsChange, onColumnsCountChange: onColumnsCountChange, onLoadDataChange: onLoadDataChange, data: data, status: status, loading: loading }))));
};
export default App;

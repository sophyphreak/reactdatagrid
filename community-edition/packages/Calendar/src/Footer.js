...
export const FooterButton = props => {
    const disabledClassName = props.disabled
        ...
        : '';
    const cancelButtonClass = props.children === 'Cancel' ? `${props.rootClassName}-button-cancel` : '';
    const todayButtonClass = props.children === 'Today' ? `${props.rootClassName}-button-today` : '';
    const okButtonClass = props.children === 'OK' ? `${props.rootClassName}-button-ok` : '';
    const className = join(props.className || '', cancelButtonClass, todayButtonClass, okButtonClass, `${props.rootClassName}-button`, disabledClassName);

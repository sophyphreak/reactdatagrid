...
const GridLink = ({ value }) => (React.createElement("a", { style: gridLinkStyle, href: value, target: "_blank" }, value));
const columns = [
    ...
    { name: 'phone', renderGroupTitle, header: 'Phone' },
    {
        ...
        header: 'Website',
        renderGroupTitle,
        render: ({ data }) => React.createElement(GridLink, { value: data.website }),
    },
    {
        name: 'type',
        header: 'Type',
    ...
    },
    {
        ...
        renderGroupTitle,
        defaultVisible,
        render: ({ data }) => React.createElement(GridLink, { value: data.facebook }),
    },
    {
        name: 'twitter',
        header: 'Twitter',
        renderGroupTitle,
        defaultVisible,
        render: ({ data }) => React.createElement(GridLink, { value: data.twitter }),
    },
    {
        name: 'linkedIn',
        header: 'LinkedIn',
        renderGroupTitle,
        defaultVisible,
        render: ({ data }) => React.createElement(GridLink, { value: data.linkedIn }),
    },
];
...
const contactsColumns = [
    ...
    },
    {
        ...
        group: 'socialMedia',
        render: ({ data }) => {
            return React.createElement(GridLink, { value: data.facebook });
        },
    },
    {
        name: 'twitter',
        ...
        renderGroupTitle,
        render: ({ data }) => {
            return React.createElement(GridLink, { value: data.twitter });
        },
    },
    {
        name: 'linkedIn',
        ...
        renderGroupTitle,
        render: ({ data }) => {
            return React.createElement(GridLink, { value: data.linkedIn });
        },
    },
    {
        name: 'address',
...
const App = () => {
    ...
    const renderContactsGrid = ({ data }) => {
        ...
        return (React.createElement(ReactDataGrid, { defaultFilterValue: defaultFilterValue, dataSource: contactsDataSource, pagination: true, columns: contactsColumns, columnDefaultWidth: 200 }));
    };
    return (React.createElement(ReactDataGrid, { dataSource: accountsDataSource, style: accountsGridStyle, rowHeight: accountRowHeight, pagination: true, rowExpandHeight: accountExpandHeight, rowHeights: accountRowHeights, renderDetailsGrid: renderContactsGrid, defaultGroupBy: defaultGroupBy, columnDefaultWidth: 200, columns: columns, renderRowDetailsExpandIcon: renderRowDetailsExpandIcon, renderRowDetailsCollapsedIcon: renderRowDetailsCollapsedIcon, renderRowDetailsMoreIcon: renderRowDetailsMoreIcon }));
};

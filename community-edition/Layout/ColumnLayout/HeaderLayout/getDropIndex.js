 ...
 */
export default ({ dragTarget, dropTarget, dragMinIndex, dragMaxIndex, dragRange, ranges, rtl, dir, validDropPositions, }) => {
    ranges = ranges || [];
    ...
    const isValid = i => {
        ...
        const validDropIndex = dropTarget === 'group' || !validDropPositions || validDropPositions[i];
        if ((dragMinIndex !== undefined && i < dragMinIndex) ||
    ...
    const searchInRanges = dragTarget != dropTarget
        ? ranges
        : dir == 1

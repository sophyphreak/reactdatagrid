...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, columns: columns, pagination: true, dataSource: dataSource, defaultLimit: 10, pageSizes: [10, 50, 100] })));
};

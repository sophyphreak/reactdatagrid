...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "Grid with Excel-like cell navigation"),
        React.createElement(DataGrid, { onReady: gridApiRef => setGridRef(gridApiRef), idProperty: "id", style: gridStyle, rowIndexColumn: true, showZebraRows: false, rowHeight: 40, defaultActiveCell: DEFAULT_ACTIVE_CELL, onEditComplete: onEditComplete, onEditStart: onEditStart, onEditStop: onEditStop, editable: true, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, columns: columns, dataSource: dataSource })));
};

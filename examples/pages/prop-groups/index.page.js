...
export default () => (React.createElement("div", null,
    ...
    React.createElement(DataGrid, { idProperty: "id", style: gridStyle, columnMinWidth: 200, columns: columns, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, groups: groups, allowGroupSplitOnReorder: false, dataSource: dataSource })));

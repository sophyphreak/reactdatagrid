...
import InovuaScrollContainer, { propTypes as scrollContainerPropTypes, } from '../../../../packages/react-scroll-container-pro/src';
...
const InovuaVirtualScrollContainer = ScrollerFactory('InovuaVirtualScrollContainer', {
    init() {
    ...
    renderScroller({ props, content, spacer, scrollerStyle, renderView, viewStyle, }) {
        ...
        return (React.createElement(InovuaScrollContainer, { ...filterScrollerProps(props), onContainerScroll: this.onContainerScroll, ref: this.refScroller, 
            // flex: 1 in both inline style and via className
            // (for scenarios when) people do not include the css file
            style: FLEX_1_STYLE, className: className, scrollerStyle: scrollerStyle, renderView: renderView, viewStyle: viewStyle ? Object.assign({}, VIEW_STYLE, viewStyle) : VIEW_STYLE, resizer: false },
            content,
            spacer));
    },
});
...
}, scrollContainerPropTypes, InovuaVirtualScrollContainer.propTypes);

...
const ARROWS = {
    prev: (React.createElement("svg", { width: "6", height: "10", viewBox: "0 0 6 10" },
        React.createElement("path", { fillRule: "evenodd", d: "M2.197 5l2.865-2.866c.311-.31.311-.814 0-1.125-.31-.31-.814-.31-1.125 0L.477 4.47c-.293.294-.293.769 0 1.061l3.46 3.46c.311.311.815.311 1.125 0 .311-.31.311-.814 0-1.124L2.197 5z" }))),
    next: (React.createElement("svg", { width: "6", height: "10", viewBox: "0 0 6 10" },
        React.createElement("path", { fillRule: "evenodd", d: "M3.803 5L.938 7.866c-.311.31-.311.814 0 1.125.31.31.814.31 1.125 0l3.46-3.46c.293-.294.293-.769 0-1.061l-3.46-3.46c-.311-.311-.815-.311-1.126 0-.31.31-.31.814 0 1.124L3.803 5z" }))),
    right: (React.createElement("svg", { width: "12", height: "10", viewBox: "0 0 12 10" },
        React.createElement("g", { fillRule: "evenodd" },
            React.createElement("path", { d: "M3.803 4.5L.938 7.366c-.311.31-.311.814 0 1.125.31.31.814.31 1.125 0l3.46-3.46c.293-.294.293-.769 0-1.061L2.063.51C1.751.198 1.247.198.936.51c-.31.31-.31.814 0 1.124L3.803 4.5zM9.803 4.5L6.937 7.366c-.31.31-.31.814 0 1.125.311.31.815.31 1.125 0l3.461-3.46c.293-.294.293-.769 0-1.061L8.063.51c-.311-.311-.815-.311-1.126 0-.31.31-.31.814 0 1.124L9.803 4.5z", transform: "translate(0 .5)" })))),
    left: (React.createElement("svg", { width: "12", height: "10", viewBox: "0 0 12 10" },
        React.createElement("g", { fillRule: "evenodd" },
            React.createElement("path", { d: "M3.803 4.5L.938 7.366c-.311.31-.311.814 0 1.125.31.31.814.31 1.125 0l3.46-3.46c.293-.294.293-.769 0-1.061L2.063.51C1.751.198 1.247.198.936.51c-.31.31-.31.814 0 1.124L3.803 4.5zM9.803 4.5L6.937 7.366c-.31.31-.31.814 0 1.125.311.31.815.31 1.125 0l3.461-3.46c.293-.294.293-.769 0-1.061L8.063.51c-.311-.311-.815-.311-1.126 0-.31.31-.31.814 0 1.124L9.803 4.5z", transform: "rotate(180 6 4.75)" })))),
};
export default class NavBar extends Component {
    ...
    render() {
        ...
        const className = join(props.className, rootClassName, `${rootClassName}--theme-${props.theme}`, `${rootClassName}--with-month-decade-view`);
        ...
        return (React.createElement(Flex, { key: "navBar", inline: true, row: true, ...flexProps, className: className },
            secondary && this.renderNav(-2, viewMoment, 'left'),
            this.renderNav(-1, viewMoment, 'prev'),
            React.createElement(Item, { key: "month_year", className: join(`${rootClassName}-date`, props.monthDecadeViewEnabled ? '' : `${rootClassName}-date-disabled`), style: { textAlign: 'center' }, onMouseDown: props.monthDecadeViewEnabled ? this.toggleMonthDecadeView : null }, this.renderNavDate(viewMoment)),
    ...
    renderMonthDecadeView() {
        ...
        const { viewMoment, theme, locale, minDate, maxDate, rootClassName, size, okButtonText, cancelButtonText, showClock, enableMonthDecadeViewAnimation, showMonthDecadeViewAnimation, } = this.p;
        const className = join(`${rootClassName}-month-decade-view`, (size <= 1 || size === undefined) &&
            `${rootClassName}-month-decade-view-month`, showClock && `${rootClassName}-month-decade-view-calendar`);
        const modalClassName = join(`${rootClassName}-month-decade-view-modal`, enableMonthDecadeViewAnimation &&
            `${rootClassName}-month-decade-view-show-animation`);
        const modalWrapperClassName = size || size === undefined ? modalClassName : null;
    ...
    renderNav(dir, viewMoment, name) {
        ...
        const className = join(`${rootClassName}-arrow`, `${rootClassName}-arrow--${name}`, secondary && `${rootClassName}-secondary-arrow`, disabled && `${rootClassName}-arrow--disabled`);
        ...
        if (dirArrow) {
            ...
            children =
                dir < 0 ? (React.createElement("div", { className: arrowDivClass }, secondary ? (React.createElement("div", { className: arrowClass }, doubleArrows)) : (React.createElement("div", { className: arrowClass }, arrow)))) : (React.createElement("div", { className: arrowDivClass }, secondary ? (React.createElement("div", { className: arrowClass }, doubleArrows)) : (React.createElement("div", { className: arrowClass }, arrow))));
        }
        const navProps = {
            dir,
            name,

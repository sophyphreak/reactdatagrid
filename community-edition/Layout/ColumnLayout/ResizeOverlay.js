...
export default class ResizeOverlay extends React.Component {
    ...
    render() {
        ...
        const className = join(props.className, 'InovuaReactDataGrid__resize-overlay', active && 'InovuaReactDataGrid__resize-overlay--active');
        const proxyClassName = join('InovuaReactDataGrid__resize-proxy', constrained && 'InovuaReactDataGrid__resize-proxy--constrained');
        ...
        return (React.createElement("div", { style: style, className: className },
            React.createElement("div", { className: proxyClassName, style: proxyStyle })));
    }
}

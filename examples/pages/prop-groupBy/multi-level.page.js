...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(DataGrid, { idProperty: "id", defaultGroupBy: ['country', 'age'], defaultCollapsedGroups: { usa: true }, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, columns: columns, dataSource: people, style: { minHeight: '90vh' }, onReady: api => {

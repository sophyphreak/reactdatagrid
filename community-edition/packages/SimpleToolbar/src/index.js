...
class InovuaSimpleToolbar extends React.Component {
    render() {
        ...
        const className = join(props.className, `inovua-react-simple-toolbar`, `inovua-react-simple-toolbar--orientation-${props.orientation}`, props.theme ? `inovua-react-simple-toolbar--theme-${props.theme}` : null);
        return (React.createElement("div", { ...cleanProps(props, InovuaSimpleToolbar.propTypes), children: children, className: className }));
    }
    prepareChildren(props) {
        ...
        if (!regionCount) {
            ...
            return this.prepareRegion(React.createElement(Factory, null, children));
        }
        return children;
    }

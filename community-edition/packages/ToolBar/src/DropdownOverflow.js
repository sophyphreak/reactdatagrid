...
class DropDownOverflow extends Component {
    ...
    render() {
        ...
        const className = join(props.rootClassName, props.className, props.rtl && `${props.rootClassName}--rtl`);
        ...
        return (React.createElement("div", { ...domProps, ref: this.setRootRef, style: style, className: className },
            React.createElement(NotifyResize, { key: "notify", rafOnResize: true, notifyOnMount: false, onResize: this.handleResize }),
    ...
    renderDropdownButton() {
        ...
        if (result === undefined) {
            result = React.createElement(DropdownButton, { ...domProps });
        }
        return result;
    }
    /**
    ...
    renderGhost() {
        ...
        return (React.createElement("div", { ref: this.setGhostRef, style: {
                ...ghostStyle,

...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "RTL + stacked columns example"),
        ...
        React.createElement(ReactDataGrid, { key: `grid-${nativeScroll}`, idProperty: "id", rtl: rtl, nativeScroll: nativeScroll, style: { minHeight: small ? 350 : 650 }, columnMinWidth: 100, columns: columns, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, groups: groups, dataSource: dataSource })));
};

...
class App extends Component {
    ...
    render() {
        return (React.createElement("div", { style: { margin: 100 } },
            ...
            React.createElement(SplitButton, { onDropdownButtonClick: () => console.log('dropdown button click'), onExpandedChange: expanded => console.log('expand change'), onMenuClick: () => console.log('onMenuClick'), onClick: () => console.log('button clicked'), dropdownButtonProps: { children: 'hello world' }, theme: this.state.theme, menuProps: {
                    maxHeight: 150,
                    submenuMaxHeight: 75,

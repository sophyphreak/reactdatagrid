...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", { style: { color: '#fafafa' } }, "GroupBy example with default grouping"),
        ...
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, groupColumn: showGroupColumn ? groupColumn : null, stickyGroupRows: stickyGroupRows, defaultGroupBy: groupBy, columns: columns, dataSource: dataSource })));
};

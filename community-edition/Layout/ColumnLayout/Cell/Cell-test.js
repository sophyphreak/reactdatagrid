...
describe('DataGrid HeaderCell', () => {
    it('should respect headerEllipsis: false for columns', () => {
        const gridInstance = render(dataSource, { []:  }, columns = { [({
                name: 'firstName',
                width: 100,
                headerEllipsis: false,
                header: className, "no-ellipsis":  > FIRST < /span>,
            },
                { name: 'email', flex: 1 },
            )]:  }, idProperty = "id"
            /  >
        ...
        return wait().then(() => {
            ...
            const headersWithEllipsis = [
                ...domNode.querySelectorAll('.InovuaReactDataGrid__column-header__content.InovuaReactDataGrid__box--ellipsis'),
            ];
    ...
    it('should respect columnResizeHandleWidth', done => {
        const gridInstance = render(columnResizeHandleWidth, { 20:  }, dataSource = { []:  }, columns = { [{ name: 'firstName', width: 100, resizable: false },
                { name: 'email', flex: 1 },
            ]:  }, idProperty = "id"
            /  >
        );
        setTimeout(() => {
            const domNode = findDOMNode(gridInstance);
            const resizeHandles = [
                ...domNode.querySelectorAll('.InovuaReactDataGrid__column-resize-handle'),
            ];
...
describe('DataGrid Cell', () => {
    it('should render cells of correct width', done => {
        const gridInstance = render(columns, { [{ name: 'firstName', width: 100 },
                { name: 'email', flex: 1 },
            ]:  }, idProperty = "id", dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
        ...
        setTimeout(() => {
            const rows = [
                ...findDOMNode(gridInstance).querySelectorAll('.InovuaReactDataGrid__row'),
            ];
    ...
    it('should render cells at correct positions, without virtualization', done => {
        const gridInstance = render(columns, { [{ name: 'firstName', width: 100 },
                { name: 'email', flex: 1 },
            ]:  }, rowHeight = { 40:  }, idProperty = "id", dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
                { firstName: 'marry', email: 'marry@gmail.com', id: 2 },
                { firstName: 'paul', email: 'paul@gmail.com', id: 3 },
            ]:  }
            /  >
    ...
    it('should render cells at correct positions with virtualization', done => {
        const gridInstance = render(columns, { [{ name: 'firstName', width: 100 },
                { name: 'email', flex: 1 },
            ]:  }, virtualizeColumns, rowHeight = { 40:  }, idProperty = "id", dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
                { firstName: 'marry', email: 'marry@gmail.com', id: 2 },
                { firstName: 'paul', email: 'paul@gmail.com', id: 3 },
            ]:  }
            /  >
    ...
    it('should render virtualized cells when columns.length >= virtualizeColumnsThreshold', done => {
        const gridInstance = render(columns, { [{ name: 'firstName', width: 100 },
                { name: 'email', flex: 1 },
            ]:  }, virtualizeColumnsThreshold = { 2:  }, idProperty = "id", rowHeight = { 40:  }, dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
                { firstName: 'marry', email: 'marry@gmail.com', id: 2 },
                { firstName: 'paul', email: 'paul@gmail.com', id: 3 },
            ]:  }
            /  >
    ...
    it('should render unvirtualized cells when columns.length < virtualizeColumnsThreshold', done => {
        const gridInstance = render(columns, { [{ name: 'firstName', width: 100 },
                { name: 'email', flex: 1 },
            ]:  }, rowHeight = { 40:  }, virtualizeColumnsThreshold = { 3:  }, idProperty = "id", dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
                { firstName: 'marry', email: 'marry@gmail.com', id: 2 },
                { firstName: 'paul', email: 'paul@gmail.com', id: 3 },
            ]:  }
            /  >
    ...
    it('should respect textEllipsis: false & headerEllipsis: false', done => {
        const gridInstance = render(columns, { [({
                name: 'firstName',
                defaultWidth: 100,
                header: () => className, "header-noellipsis":  > First
            } / span > ,
                headerEllipsis)]: false,
            textEllipsis: false,
            render: ({ value }) => className, "noellipsis":  > { value } < /span>, }, {
            name: 'email',
            flex: 1,
            header: () => className, "header-ellipsis":  > Email < /span>,,
            render: ({ value }) => className, "ellipsis":  > { value } < /span>,
        });
    }, virtualizeColumnsThreshold = { 3:  }, idProperty = "id", dataSource = { [{ firstName: 'john', email: 'john@gmail.com', id: 1 },
            { firstName: 'marry', email: 'marry@gmail.com', id: 2 },
            { firstName: 'paul', email: 'paul@gmail.com', id: 3 },
        ]:  }
        /  >
    ...
    setTimeout(() => {
        ...
        const hasEllipsis = node => getComputedStyle(node.parentElement)['text-overflow'] === 'ellipsis';

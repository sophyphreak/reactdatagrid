...
export default (props, column, index, columns) => {
    ...
    return (React.createElement(MenuItemCell, { style: style, className: className, key: index, rootClassName: rootClassName, cellProps: cellProps, isDescription: column.isDescription, isIcon: column.isIcon, align: column.align }, children));
};

...
class App extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            ...
            React.createElement(DataGrid, { style: gridStyle, columns: this.state.columns, dataSource: this.state.dataSource, defaultGroupBy: ['age'], licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY })));
    }
}

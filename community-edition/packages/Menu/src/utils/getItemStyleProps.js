...
export default props => {
    const { itemStyle, itemOverStyle, itemOverClassName, itemActiveStyle, itemActiveClassName, itemDisabledStyle, itemDisabledClassName, itemExpandedStyle, itemExpandedClassName, cellStyle, itemFocusedStyle, itemFocusedClassName, itemOverFocusedStyle, } = props;
    return {
        style: itemStyle,

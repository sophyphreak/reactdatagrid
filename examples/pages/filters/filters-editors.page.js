...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, onFilterValueChange: onFilterValueChange, filterValue: filterValue, columns: columns, dataSource: dataSource, filteredRowsCount: filteredRowsCount }),

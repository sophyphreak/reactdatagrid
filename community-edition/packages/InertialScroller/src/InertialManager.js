...
class InertialManager {
    constructor({ node, viewNode, arrowSelector, threshold = 5, timeConstant = 360, initialAmplitude = 0.8, enableMouseDrag = true, enableTouchDrag = true, setScrollPosition = () => { }, }) {
        this.node = node;
    ...
    hasScroll() {
        if ((this.viewNode && this.viewNode.offsetHeight) !== undefined &&

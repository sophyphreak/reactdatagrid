...
function getValueProps({ state, props, computed, tagProps }) {
    const { multiple, renderTag, renderTags, tagBorder, tagStyle, tagPadding, tagHeight, tagWidth, tagMinSize, tagMaxSize, wrapMultiple, tagCloseIcon, tagCloseIconPosition, maxTagsLength, rtl, renderRemainingTags, renderDisplayValue, searchable, renderTagLabel, } = props;
    const { focus } = state;

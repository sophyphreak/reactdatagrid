 ...
 */
import { expandAtIndex, expandAtIndexes, expandByIdsWithInfo, collapseAtIndexes, collapseAtIndex, sortTreeData, } from './index';
...
xdescribe('expandByIds', () => {
    it('index', () => {
        ...
        const { data: expandedSource, idToIndexMap } = expandByIdsWithInfo(dataSource, {
            11: true,
            3: true,
            5: true,
            9: true,
...
xdescribe('expandAtIndex', () => {
    it('index', () => {
        const dataSource = expandAtIndex([{ id: 2 }, { id: 3, nodes: [{ id: 4 }] }, { id: 5 }], 1, { generateIdFromPath: true });
    ...
    it('index without generateIdFromPath', () => {
        const dataSource = expandAtIndex([{ id: 2 }, { id: 3, nodes: [{ id: 4 }] }, { id: 5 }], 1, { generateIdFromPath: false });
        expect(dataSource).toEqual([
            {
                id: 2,
            },

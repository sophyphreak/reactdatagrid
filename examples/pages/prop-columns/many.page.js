    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { style: { marginBottom: 20 } },
                React.createElement(CheckBox, { checked: this.state.rtl, onChange: value => this.setState({ rtl: value }) }, "RTL")),
            React.createElement("div", { style: { marginBottom: 20 } },
            ...
            React.createElement(DataGrid, { idProperty: "id", style: gridStyle, handle: x => {
                    globalObject.x = x;
                }, columns: this.state.columns, dataSource: this.state.dataSource, rtl: this.state.rtl })));
    }
}

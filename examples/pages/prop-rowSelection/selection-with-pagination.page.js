...
const renderDateTime = value => {
    ...
    return React.createElement("span", null, moment(value).format('MM/DD/YYYY hh:mm'));
};
...
const remoteColumns = [
    ...
    { ...email },
    {
        ...
        render: ({ value }) => {
            ...
            return [
                React.createElement("div", { style: phoneStyle, key: "phone-icon" }, phoneIcon),
                React.createElement("span", { key: "whitespace", style: { marginLeft: 22 } }),
                value,
            ];
        },
    },
    {
        ...
        filterDelay: 500,
        type: 'number',
        render: ({ value }) => value == null ? null : `$ ${toLocaleFloatNumber(value)}`,
...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { theme: "default-dark", checked: pagination, onChange: setPagination }, "Pagination")),
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { checked: remoteGrid, onChange: setRemoteGrid }, "Remote Grid")),
        !remoteGrid && [
            React.createElement("h3", { key: "local-title" }, "Local Data"),
            React.createElement(ReactDataGrid, { key: `grid-local-${pagination}`, idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, handle: setLocalGridRef, enableSelection: true, multiSelect: true, pagination: pagination, checkboxColumn: true, onSelectionChange: onLocalSelectionChange, style: localGridStyle, columns: localColumns, dataSource: people }),
            React.createElement("p", { key: "local-text" },
                "Local selected rows:",
                ' ',
        ...
        remoteGrid && [
            React.createElement("h3", { key: "title" }, "Remote Data"),
            React.createElement(ReactDataGrid, { key: `grid-remote-${pagination}`, idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, handle: setRemoteGridRef, enableSelection: true, multiSelect: true, pagination: pagination, checkboxColumn: true, onSelectionChange: onRemoteSelectionChange, style: remoteGridStyle, columns: remoteColumns, dataSource: remoteDataSource }),

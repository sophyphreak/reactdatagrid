...
export default class Calendar extends Component {
    ...
    render() {
        ...
        const monthView = (React.createElement(MonthView, { ...monthViewProps, onChange: this.onChange, className: null, style: null, ref: view => {
                this.view = view;
            }, renderChildren: this.renderChildren, showClock: props.showClock }));
        return (React.createElement(Flex, { inline: true, row: true, wrap: false, className: className, style: props.style }, monthView));
    }
    ...
    renderChildren([navBar, inner, footer]) {
        ...
        return (React.createElement(Flex, { key: "date_picker_comp", column: true, wrap: false, alignItems: "stretch" }, [
            navBar
                ? React.cloneElement(navBar, { key: 'calendar_navBar' })
                : null,
            React.createElement(Flex, { key: "calendar_inner", justifyContent: "center", wrap: this.props.wrap || this.props.wrapTime },
                React.createElement(Flex, { flexGrow: "1", flexShrink: "0", flexBasis: "auto", column: true, wrap: false, alignItems: "stretch", children: inner }),
                clockInput),
            footer
    ...
    renderClockInput() {
        ...
        return React.createElement(ClockInput, { ...clockInputProps });
    }
    onClockInputFocus() {
        this.setState({
            timeFocused: true,

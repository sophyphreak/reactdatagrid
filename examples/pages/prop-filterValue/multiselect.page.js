...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("p", null,
            "Visible columns: ",
            gridRef?.current.visibleColumns.length),
        React.createElement(ReactDataGrid, { onReady: ref => {
                ref.current.collapseAllGroups();
                setGridRef(ref);
            }, enableFiltering: true, columns: columns, defaultFilterValue: defaultFilterValue, dataSource: people, style: { minHeight: 550 }, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY })));
};

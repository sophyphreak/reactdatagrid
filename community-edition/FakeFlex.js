...
class FakeFlex extends Component {
    ...
    render() {
        ...
        const resizer = !useNativeFlex ? (React.createElement(NotifyResize, { key: "fakeflexresizer", onResize: this.onResize, notifyOnMount: true, ResizeObserver: ResizeObserver })) : null;
        if (useFragment && !useNativeFlex) {
            return (React.createElement(React.Fragment, { key: "fragment" },
                children,
                resizer));
        }
        return (React.createElement("div", { ref: this.flexRef, style: useNativeFlex ? nativeFlexCoverStyle : coverStyle },
            children,
            resizer));
    }
}

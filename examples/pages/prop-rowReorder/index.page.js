...
const sportDataSource = () => Promise.resolve([
    {
        country: 'USA',
...
class App extends React.Component {
    ...
    isRowReorderValidHandle = ({ dragRowIndex, dropRowIndex, dragRowData, dropRowData, }) => {
    ...
    render = () => {
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { style: {
                ...
                React.createElement("h2", { style: { color: '#fafafa' } }, "DataGrid --- Row reorder example"),
                React.createElement("div", { style: {
                        flex: 1,
                        position: 'relative',
                        height: 'calc(100% - 68px)',
                    } },
                    React.createElement(DataGrid, { key: `${this.state.rowHeight}-${this.state.defaultColumnWidth}`, idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, checkboxColumn: true, onRowReorder: true, showZebraRows: false, style: gridStyle, columns: this.state.columns, dataSource: this.state.dataSource, isRowReorderValid: this.isRowReorderValidHandle, rowHeight: this.state.rowHeight, rowIndexColumn: true, rowReorderColumn: true, renderRowReorderProxy: this.renderRowProxyHandle }))),

...
const App = () => {
    ...
    const renderCollapseTool = ({ domProps, size }) => {
        ...
        return (React.createElement("svg", { ...domProps, height: size, viewBox: "0 0 24 24", width: size },
    ...
    const renderTreeLoadingTool = ({ domProps, size, className }) => {
        return (React.createElement("svg", { ...domProps, className: className, height: size, viewBox: "0 0 24 24", width: size, fill: "#49ffff" },
            React.createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "TreeGrid with custom collapse tool"),
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { theme: "default-dark", checked: showTools, onChange: setShowTools }, "Show custom tools")),
        React.createElement(ReactDataGrid, { treeColumn: "name", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, defaultExpandedNodes: defaultExpandedNodes, style: gridStyle, columns: columns, dataSource: treeData, renderTreeCollapseTool: showTools ? renderCollapseTool : null, renderTreeExpandTool: showTools ? renderExpandTool : null, renderTreeLoadingTool: showTools ? renderTreeLoadingTool : null, loadNode: loadNode, expandOnMouseDown: true })));
};

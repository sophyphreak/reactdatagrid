...
export default class GroupToolbarItem extends React.Component {
    ...
    render() {
        ...
        const className = join(props.className, 'InovuaReactDataGrid__group-toolbar-item', dragging && 'InovuaReactDataGrid__group-toolbar-item--dragging', `InovuaReactDataGrid__group-toolbar-item--direction-${this.props.rtl ? 'rtl' : 'ltr'}`, sortable && 'InovuaReactDataGrid__group-toolbar-item--sortable', props.placeholder &&
            'InovuaReactDataGrid__group-toolbar-item--placeholder', `InovuaReactDataGrid__group-toolbar-item--theme-${props.theme}`);
...
GroupToolbarItem.defaultProps = {
    clearIcon: (React.createElement("svg", { height: ICON_SIZE, width: ICON_SIZE, viewBox: "0 0 10 10" },

...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("h3", null, "Persons Manager "),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, editable: true, onEditComplete: onEditComplete, columns: columns, dataSource: dataSource, defaultFilterValue: filterValue })));
};

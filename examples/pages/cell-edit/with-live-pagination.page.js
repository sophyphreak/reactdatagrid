...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { theme: "default-dark", checked: livePagination, onChange: setLivePagination }, "Live pagination")),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, key: 'grid-' + livePagination, style: gridStyle, columns: columns, livePagination: livePagination, pagination: true, sortable: false, dataSource: dataSource, limit: 15, editable: true })));
};

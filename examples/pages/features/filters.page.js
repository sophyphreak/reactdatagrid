...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(Button, { theme: "default-dark", onClick: () => setKey(key + 1) }, "Change key")),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", key: `grid_${key}`, handle: setGridRef, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, defaultFilterValue: filterValue, columns: columns, dataSource: people, defaultSortInfo: { name: 'name', dir: 1 } }),

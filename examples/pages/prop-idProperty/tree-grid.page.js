...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("p", null,
            ...
            "."),
        React.createElement(ReactDataGrid, { treeColumn: "name", idProperty: "treeId", expandedNodes: expandedNodes, onExpandedNodesChange: onExpandedNodesChange, style: gridStyle, columns: columns, dataSource: treeData, rowReorderColumn: true, enableTreeRowReorder: true, onTreeRowReorderEnd: onTreeRowReorderEnd })));
};

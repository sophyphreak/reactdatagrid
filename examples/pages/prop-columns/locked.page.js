...
class App extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(DataGrid, { idProperty: "id", style: gridStyle, theme: "default-light", defaultGroupBy: defaultGroupBy, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, columns: this.state.columns, dataSource: this.state.dataSource }));
    }
}

...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(Button, { onClick: startEdit }, "Start edit")),
        React.createElement(ReactDataGrid, { idProperty: "id", handle: setGridRef, defaultGroupBy: [], style: gridStyle, onEditComplete: onEditComplete, editable: true, columns: columns, dataSource: dataSource })));
};

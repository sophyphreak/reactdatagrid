...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { ...checkboxProps }, "Enable Column Filter Context Menu")),
        React.createElement(ReactDataGrid, { idProperty: "id", style: gridStyle, defaultFilterValue: defaultFilterValue, columns: columns, dataSource: people, enableColumnFilterContextMenu: enableColumnFilterContextMenu })));
};

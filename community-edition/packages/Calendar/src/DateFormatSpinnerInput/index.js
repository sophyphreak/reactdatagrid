...
export default class DateFormatSpinnerInput extends Component {
    ...
    render() {
        ...
        assignDefined(inputProps, {
            ...
            changeDelay: props.changeDelay === undefined
            ...
            onChange,
            disabled,
            dateFormat: props.dateFormat === undefined
        ...
        this.arrows = {
            1: (React.createElement("svg", { height: arrowSize / 2, width: arrowSize, viewBox: "0 0 10 5" },
        ...
        const className = join(props.className, rootClassName, this.state.focused
            ? `${rootClassName}-spinner--focused`
            : `${rootClassName}-spinner`, disabled && `${rootClassName}--disabled`, this.isFocused() && `${rootClassName}--focused`, `${rootClassName}--theme-${props.theme}`);

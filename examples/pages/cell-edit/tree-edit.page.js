...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("p", null,
            ...
            "."),
        React.createElement(ReactDataGrid, { treeColumn: "name", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, expandedNodes: expandedNodes, onExpandedNodesChange: onExpandedNodesChange, style: gridStyle, columns: columns, dataSource: dataSource, editable: true, onEditComplete: onEditComplete })));
};

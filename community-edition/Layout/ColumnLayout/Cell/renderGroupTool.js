...
export default ({ render, rtl, collapsed, toggleGroup, style, size, }, cellProps) => {
    ...
    if (collapsed) {
        return (React.createElement("svg", { ...domProps, height: size, viewBox: "0 0 24 24", width: size }, rtl ? (React.createElement("path", { d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z" })) : (React.createElement("path", { d: "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z" }))));
    }

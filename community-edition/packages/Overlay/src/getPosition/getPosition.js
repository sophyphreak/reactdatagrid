...
// position
function getPosition({ constrainTo = true, targetNode, overlayNode, offset, positions, relativeToViewport, arrowSize, }) {
    ...
    const positionsNormalized = positions.map(position => positionsMap[position].position);

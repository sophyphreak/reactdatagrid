...
const flags = {
  ca: React.createElement(
    ...
    React.createElement(
      'svg',
      { viewBox: '0 0 48 48', width: '32px', height: '32px' },
      ...
      React.createElement('path', {
        fill: '#FF3D00',
        d:
          'M33,27l-2-1l2-3h-3l-0.041-1.986l-2.311,1.159L28,17l-2,1l-1.993-3L22,18l-2-1l0.352,5.144l-2.312-1.128c0,0-0.045,1.974-0.04,1.984h-3l2,3l-2,1l4,2v2c0,0,4.722-0.259,5-0.259S29,31,29,31v-2L33,27z',
      })
    )
  ),
  uk: React.createElement(
    'div',
    {
      style: {
        display: 'inline-flex',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('path', {
          fill: '#E53935',
          d:
            'M17.218 20L2 10.699 2 13.043 13.382 20zM44.309 10L27.947 20 31.782 20 46 11.311 46 10zM33.082 28L46 35.895 46 33.551 36.917 28zM15.918 28L2 36.506 2 38 3.392 38 19.753 28zM2 22H46V26H2z',
        }),
  ...
  usa: React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('path', {
        fill: '#F44336',
        d:
          'M2 10H46V13H2zM2 16H46V19H2zM2 22H46V25H2zM2 28H46V31H2zM2 34H46V37H2z',
      }),

...
export default class DragCell extends React.Component {
    ...
    render() {
        if (this.state.visible) {
            ...
            return (React.createElement(Cell, { ...props, maxWidth: maxWidth, computedWidth: computedWidth, className: className, headerWrapperClassName: headerWrapperClassName, onMount: this.onCellMount, onUnmount: this.onCellUnmount }));
        }
        return null;
    }

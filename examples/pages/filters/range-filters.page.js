...
const App = () => {
    return (React.createElement("div", null,
        React.createElement("h3", null, "Filterable DataGrid with date filter"),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, enableFiltering: true, defaultFilterValue: defaultFilterValue, columns: columns, dataSource: contacts })));
};

...
import DateInput from '../../../community-edition/packages/Calendar/DateInput';
...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(DateInput, { dateFormat: "DD-MM-YYYY", theme: "default-dark", calendarProps: {
                    todayButtonText: 'Now',
                    clearButtonText: 'Delete',
                    okButtonText: 'Sure',
                    cancelButtonText: 'Back',
                } })),
        React.createElement(ReactDataGrid, { idProperty: "id", theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, style: gridStyle, defaultFilterValue: filterValue, columns: columns, dataSource: people, i18n: i18n }),

...
const App = () => {
    return (React.createElement("div", { style: { minHeight: '200vh' } },
        React.createElement(DataGrid, { columns: columns, idProperty: "id", style: gridStyle, dataSource: dataSource, editable: true, defaultCellSelection: [], licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, checkboxColumn: false, rowIndexColumn: true, onRowReorder: true, defaultGroupBy: [], maxRowHeight: 150, minRowHeight: 20 })));
};

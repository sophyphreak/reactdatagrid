...
import DecadeView, { prepareDateProps, getInitialState, onViewDateChange, onActiveDateChange, onChange, navigate, select, confirm, gotoViewDate, } from './DecadeView';
...
export default class MonthDecadeView extends Component {
    ...
    render() {
        ...
        return (React.createElement(Flex, { inline: true, column: true, alignItems: "stretch", ...flexProps, className: className },
            this.renderYearView(yearViewProps),
            React.createElement("div", { className: separatorClassName }),
    ...
    renderFooter() {
        ...
        const defaultFooterProps = assignDefined({}, { okButtonText, cancelButtonText, theme: props.theme });
        ...
        return (React.createElement(Footer, { key: "month_decade_footer", ...defaultFooterProps, todayButton: false, clearButton: false, onOkClick: this.onOkClick, onCancelClick: this.onCancelClick, centerButtons: true }));
    }
    onOkClick() {
    ...
    renderYearView(yearViewProps) {
        ...
        const tabIndex = yearViewChildProps.tabIndex == null ? null : yearViewChildProps.tabIndex;
        ...
        assign(yearViewProps, {
            onViewDateChange: joinFunctions(this.onViewDateChange, yearViewChildProps.onViewDateChange),
            onActiveDateChange: joinFunctions(this.onActiveDateChange, yearViewChildProps.onActiveDateChange),
            onChange: joinFunctions(this.handleYearViewOnChange, yearViewChildProps.onChange),
        });
        if (yearViewChild) {
            return React.cloneElement(yearViewChild, yearViewProps);
        }
        return React.createElement(YearView, { ...yearViewProps });
    }
    renderDecadeView(decadeViewProps) {
        ...
        assign(decadeViewProps, {
            onConfirm: joinFunctions(this.handleDecadeViewOnConfirm, decadeViewChildProps.onConfirm),
            onViewDateChange: joinFunctions(this.handleDecadeOnViewDateChange, decadeViewChildProps.onViewDateChange),
            onActiveDateChange: joinFunctions(this.handleDecadeOnActiveDateChange, decadeViewChildProps.onActiveDateChange),
            onChange: joinFunctions(this.handleDecadeOnChange, decadeViewChildProps.onChange),
        });
        if (decadeViewChild) {
            return React.cloneElement(decadeViewChild, decadeViewProps);
        }
        return React.createElement(DecadeView, { ...decadeViewProps });
    }
    onYearViewFocus() {

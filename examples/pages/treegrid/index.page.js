...
const App = () => {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(ReactDataGrid, { treeColumn: "name", loadNode: loadNode, stickyTreeNodes: true, defaultExpandedNodes: defaultExpandedNodes, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, treeNestingSize: treeNestingSize, style: gridStyle, columns: columns, dataSource: treeData })));
};

...
class InovuaTextEditor extends React.Component {
    ...
    render() {
        ...
        const className = 'InovuaReactDataGrid__cell__editor InovuaReactDataGrid__cell__editor--text ' +
            (domProps.className || '');
        return (React.createElement(TextInput, { autoFocus: props.autoFocus, value: value, theme: props.theme, onChange: this.onChange, onBlur: this.onBlur, onKeyDown: this.onKeyDown, enableClearButton: true, ...domProps, className: className }));
    }
    onChange(value, e) {

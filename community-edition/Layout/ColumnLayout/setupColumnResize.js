...
const emptyFn = () => { };
export default function ({ region, headerRegion, constrainTo, columnHeaderNodes, columns, rtl, index, firstFlexIndex, shareSpace, shareSpaceOnResize, initialSize, nextColumnSize, extraOffset, groupColumns, }, { onResizeDragInit = emptyFn, onResizeDragStart = emptyFn, onResizeDrag = emptyFn, onResizeDrop = emptyFn, }, event) {
    ...
    const isContrained = dragRegion => {
        const constrained = dragRegion.left <= constrainTo.left ||

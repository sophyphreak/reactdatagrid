 ...
 */
const dropIndexValidation = ({ data, count, dragIndex, dropIndex, isRowReorderValid, selectedGroup, allowRowReoderBetweenGroups, computedGroupBy, computedTreeEnabled, }) => {

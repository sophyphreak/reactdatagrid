        ...
        this.state = {
            ...
            columns: [
                ...
                { name: 'size', defaultWidth: 120 },
                {
                    id: 'toggle',
                    render: data => {
                        return (React.createElement(Button, { theme: "default-dark", onClick: () => data.toggleNodeExpand() }, "toggle"));
                    },
                },
            ],
            dataSource: treeData,
    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement("p", null,
                ...
                "."),
            React.createElement(DataGrid, { treeColumn: "name", theme: "default-dark", expandedNodes: expandedNodes, licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, onExpandedNodesChange: this.onExpandedNodesChange, style: gridStyle, columns: this.state.columns, dataSource: this.state.dataSource })));
    }
}

...
export default function App() {
    ...
    return (React.createElement("div", { className: "App" },
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { theme: "default-dark", checked: showEmptyRows, onChange: setShowEmptyRows }, "showEmptyRows"),
            React.createElement(CheckBox, { theme: "default-dark", style: { marginLeft: 10 }, checked: short, onChange: () => {
                    setLarge(false);
                    setShort(!short);
                } }, "short"),
            React.createElement(CheckBox, { theme: "default-dark", style: { marginLeft: 10 }, checked: large, onChange: () => {
                    setShort(false);
                    setLarge(!large);
                } }, "large grid"),
            React.createElement(CheckBox, { theme: "default-dark", style: { marginLeft: 10 }, checked: nativeScroll, onChange: setNativeScroll }, "nativeScroll"),
            React.createElement(CheckBox, { theme: "default-dark", style: { marginLeft: 10 }, checked: rtl, onChange: setRtl }, "RTl"),
            React.createElement(CheckBox, { theme: "default-dark", style: { marginLeft: 10 }, checked: grouping, onChange: setGrouping }, "Grouping")),
        React.createElement(ReactDataGrid, { style: {
                minHeight: short ? 300 : large ? 800 : 500,
                marginTop: 16,
            }, key: `${showEmptyRows}-${short}-${nativeScroll}-${rtl}-${grouping}`, rowHeight: 50, theme: "default-dark", licenseKey: process.env.NEXT_PUBLIC_LICENSE_KEY, idProperty: "uniqueId", dataSource: rows, columns: columns, editable: true, pagination: true, defaultFilterValue: defaultFilterValue, showColumnMenuTool: false, headerProps: headerProps, scrollProps: scrollProps, defaultShowEmptyRows: showEmptyRows, nativeScroll: nativeScroll, rtl: rtl, groups: grouping ? groups : undefined, groupBy: ['materialName'] })));
}

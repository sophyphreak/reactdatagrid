...
const App = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { marginBottom: 20 } },
            React.createElement(CheckBox, { checked: textEllipsis, onChange: onTextEllipsisChange }, "Show text ellipsis on description header and column.")),
        React.createElement(ReactDataGrid, { idProperty: "id", style: gridStyle, columns: columns, dataSource: people })));
};
